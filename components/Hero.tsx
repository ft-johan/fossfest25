  ...
  return (
    <div className="relative w-full h-[100svh] overflow-hidden bg-jwhite ">
      ...
      <div className="flex flex-col items-center justify-center h-full -m-10 px-4 text-center z-30 relative">
       ...
       <a href="https://konfhub.com/foss-fest-25"> <button data-speed="1.5" className="relative inline-flex h-12 md:h-14 lg:h-16 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 w-full max-w-xs md:max-w-sm lg:max-w-md mx-auto">
